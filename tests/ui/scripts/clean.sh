...
echo "[clean] project=$UI_FIREBASE_PROJECT_ID firestore=$UI_FIRESTORE_EMULATOR_HOST:$UI_FIRESTORE_EMULATOR_PORT auth=$UI_AUTH_EMULATOR_HOST:$UI_AUTH_EMULATOR_PORT"
